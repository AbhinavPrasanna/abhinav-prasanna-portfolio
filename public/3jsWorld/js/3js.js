...
class BasicWorldDemo {
  ...
  _Initialize() {
    ...
    this._container = document.body.querySelector("#MinecraftWorld");
    ...
    const near = 1.0;
    const far = 1000.0;
    const w = this._container.clientWidth || 570;
    const h = this._container.clientHeight || 570;
    this._camera = new THREE.PerspectiveCamera(fov, w / h, near, far);
    ...
    const texture = loader.load([
        '/3jsWorld/resources/posx.png',
        '/3jsWorld/resources/negx.png',
        '/3jsWorld/resources/posy.png',
        '/3jsWorld/resources/negy.png',
        '/3jsWorld/resources/posz.png',
        '/3jsWorld/resources/negz.png',
    ]);
    ...
    const plane = new THREE.Mesh(
        ...
        new THREE.MeshStandardMaterial({
            map: text.load('/3jsWorld/resources/grass.jpeg'),
    ...
    var cubematerials = [
      new THREE.MeshBasicMaterial({map: text.load('/3jsWorld/resources/minecraftdirt.jpeg'), side: THREE.DoubleSide}), //right
      new THREE.MeshBasicMaterial({map: text.load('/3jsWorld/resources/minecraftdirt.jpeg'), side: THREE.DoubleSide}), //left
      new THREE.MeshBasicMaterial({map: text.load('/3jsWorld/resources/grass.jpeg'), side: THREE.DoubleSide}), //top
      new THREE.MeshBasicMaterial({map: text.load('/3jsWorld/resources/grass.jpeg'), side: THREE.DoubleSide}), //bottom
      new THREE.MeshBasicMaterial({map: text.load('/3jsWorld/resources/minecraftdirt.jpeg'), side: THREE.DoubleSide}), //front
      new THREE.MeshBasicMaterial({map: text.load('/3jsWorld/resources/minecraftdirt.jpeg'), side: THREE.DoubleSide}), //back

    ];
    var diamondmaterials = [
      new THREE.MeshBasicMaterial({map: text.load('/3jsWorld/resources/diamondblock.png'), side: THREE.DoubleSide}), //right
      new THREE.MeshBasicMaterial({map: text.load('/3jsWorld/resources/diamondblock.png'), side: THREE.DoubleSide}), //left
      new THREE.MeshBasicMaterial({map: text.load('/3jsWorld/resources/diamondblock.png'), side: THREE.DoubleSide}), //top
      new THREE.MeshBasicMaterial({map: text.load('/3jsWorld/resources/diamondblock.png'), side: THREE.DoubleSide}), //bottom
      new THREE.MeshBasicMaterial({map: text.load('/3jsWorld/resources/diamondblock.png'), side: THREE.DoubleSide}), //front
      new THREE.MeshBasicMaterial({map: text.load('/3jsWorld/resources/diamondblock.png'), side: THREE.DoubleSide}), //back
    ];
    var glowstonematerials = [
      new THREE.MeshBasicMaterial({map: text.load('/3jsWorld/resources/glowstone.png'), side: THREE.DoubleSide}), //right
      new THREE.MeshBasicMaterial({map: text.load('/3jsWorld/resources/glowstone.png'), side: THREE.DoubleSide}), //left
      new THREE.MeshBasicMaterial({map: text.load('/3jsWorld/resources/glowstone.png'), side: THREE.DoubleSide}), //top
      new THREE.MeshBasicMaterial({map: text.load('/3jsWorld/resources/glowstone.png'), side: THREE.DoubleSide}), //bottom
      new THREE.MeshBasicMaterial({map: text.load('/3jsWorld/resources/glowstone.png'), side: THREE.DoubleSide}), //front
      new THREE.MeshBasicMaterial({map: text.load('/3jsWorld/resources/glowstone.png'), side: THREE.DoubleSide}), //back
    ]
    var wall = [];
    ...
    const iso = new THREE.Mesh(
      ...
      new THREE.MeshStandardMaterial({
        map: text.load('/3jsWorld/resources/endblock.png'),
      }));
    ...
    const pillar = new THREE.Mesh(
      ...
      new THREE.MeshStandardMaterial({
        map: text.load('/3jsWorld/resources/column.jpg'),
      }));
  ...
  _LoadModel() {
    ...
    loader.load('/3jsWorld/resources/minecraft_-_steve/scene.gltf', (gltf) => { // retrieved from this video: https://www.youtube.com/watch?v=8n_v1aJmLmc&t=257s&ab_channel=SimonDev
    ...
    loader2.load('/3jsWorld/resources/minecraft_-_sheep/scene.gltf', (gltf) => {
      gltf.scene.traverse(c => {
        c.castShadow = true;
        c.receiveShadow = true;
      });
    ...
    loader3.load('/3jsWorld/resources/minecraft_-_pig/scene.gltf', (gltf) => {
      gltf.scene.traverse(c => {
        c.castShadow = true;
        c.receiveShadow = true;
      });
    ...
    loader4.load('/3jsWorld/resources/minecraft_-_wolf/scene.gltf', (gltf) => {
      gltf.scene.traverse(c => {
        c.castShadow = true;
        c.receiveShadow = true;
      });
...
function startDemo() {
  const container = document.getElementById('MinecraftWorld');
  if (!container) return;
  function init() {
